...
function SignUp() {
  ...
  try {
    ...
    const { data } = await axios.post(
      ...
      {
        token, // send this so the backend can verify identity
    ...
    navigate(role === "owner" ? "/owner" : "/"); // redirect if needed
  } catch (error) {
        ...
        <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
            ...
            <p className='text-gray-600 mb-8'>Create your account to get started with delicious food deliveries</p>
             ...
             <div className='mb-4'>
                ...
                <input type = "text" className='w-full border rounded-lg px-3 py-2 focus:outline-none'placeholder='Enter your Full Name' style={{
                    border:`1px solid ${borderColor}`
             ...
             <div className='mb-4'>
                ...
                <input type = "text" className='w-full border rounded-lg px-3 py-2 focus:outline-none 'placeholder='Enter your Mobile Number' style={{
                    border:`1px solid ${borderColor}`
