    ...
    <div className="flex bg-white rounded-lg shadow-md overflow-hidden border border-[#ff4d2d] w-full max-w-2xl">
      ...
      <div className="flex flex-col justify-between p-3 flex-1">
        ...
        <div className="flex items-center justify-between">
          <div className="text-[#ff4d2d]">{data.price}</div>
          <div className=" flex items-center gap-2 ">
            <div className="p-2 cursor-pointer rounded-full hover:bg-[#ff4d2d]">
              <FaPen size={16} onClick={() => navigate(`/edit-item/${data._id}`)}/>
            </div>
            <div className="p-2 cursor-pointer rounded-full hover:bg-[#ff4d2d]"onClick={handleDeleteItem}>
              <FaTrashAlt size={16} />
            </div>
          </div>
        </div>
