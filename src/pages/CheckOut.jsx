...
function CheckOut() {
  ...
  const getAddressByLatLng = async (lat, lng) => {
    try {
      ...
      // console.log("Address:", response.data?.results[0]?.address_line2);

      dispatch(
        setAddress(
          response.data?.results[0]?.address_line2 || "Unknown Address"
        )
      );
    } catch (error) {
      console.log(error);
...
const openRazorpayWindow=(orderId, razorOrder)=>{
 ...
 rzp.open()
  ...
  return (
    <div
      className="min-h-screen bg-[#fff9f6] flex items-center justify-center
    p-6"
    >
      <div
      ...
      <div
        className="w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6
      space-y-6"
      >
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              bg-purple-100"><FaMobileAlt  className="text-purple-700 text-lg"/></span>
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-full
              bg-blue-100"><FaCreditCard  className="text-blue-700 text-lg"/></span>
              <div>
