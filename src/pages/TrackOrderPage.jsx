      ...
      {currentOrder?.shopOrders?.map((shopOrder, index) => (
        ...
        >
          ...
          {(shopOrder?.assignedDeliveryBoy && shopOrder.status!=="delivered") &&
            shopOrder.assignedDeliveryBoy.location?.coordinates?.[0] !== undefined &&
            shopOrder.assignedDeliveryBoy.location?.coordinates?.[1] !== undefined &&
            currentOrder?.deliveryAddress?.latitude !== undefined &&
            currentOrder?.deliveryAddress?.longitude !== undefined && (
