...
function CategoryCard({name, image, onClick }) {
  ...
  return (
    ...
    shadow-gray-200 hover:shadow-lg transition-shadow relative'onClick={onClick}> 
      ...
      <div className='absolute bottom-0 w-full left-0 bg-[#ffffff96] bg-opacity-95 px-3 py-1 
      rounded-t-xl text-center shadow text-sm font-medium text-gray-800 backdrop-blur'>
        {name}
      </div>
