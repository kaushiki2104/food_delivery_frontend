...
function Nav() {
  ...
  const [showSearch, setSohwSearch] = useState(false);
    ...
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
      {showSearch && userData?.role == "user" && (
        <div className="w-[90%] h-[70px] bg-white shadow-xl rounded-lg items-center gap-[20px] flex fixed top-[80px] left-[5%]">
          <div className="flex items-center w-[30%] overflow-hidden gap-[10px] px-[10px] border-r border-gray-400">
      ...
      <div className="flex items-center gap-4">
        {userData?.role == "user" &&
          (showSearch ? (
            <RxCross2
              ...
              onClick={() => setSohwSearch(false)}
            />
          ) : (
            <IoMdSearch
              size={25}
              className="text-[#ff4d2d] md:hidden"
              onClick={() => setSohwSearch(true)}
            />
          ))}
       ...
       items-center justify-center bg-[#ff4d2d] text-white text-[18px] shadow-xl font-semibold cursor-pointer"
          onClick={() => setSohwInfo((prev) => !prev)}
        >
