        ...
        <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8'>
            ...
            &&
             <div>
               ...
               <button className={`w-full font-semibold rounded-lg  py-2 transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer`} onClick={handleSendOtp} disabled={loading}>
           ...
           {error &&  <p className='text-red-500 text-center my-[10px]'>{error}</p> }
            ...
            &&
             <div>
               ...
               <button className={`w-full font-semibold rounded-lg  py-2 transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer`} onClick={handleVerifyOtp} disabled={loading}>
           ...
           {error &&  <p className='text-red-500 text-center my-[10px]'>{error}</p> }
            ...
            &&
             <div>
               ...
               <button className={`w-full font-semibold rounded-lg  py-2 transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer`} onClick={handleResetPassword} disabled={loading}>
