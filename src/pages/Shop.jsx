...
function Shop() {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <button className='absolute top-4 left-4 z-20 flex items-center gap-2 bg-black/50 hover:bg-black/70 text-white px-3 py-2 rounded-full
      shadow trensition cursor-pointer' onClick={()=>navigate("/")}>
        <FaArrowLeft />
        <span>Back</span>
      ...
      {shop && <div className='relative w-full h-64 md:h-80 lg:h-96'>
        ...
        <div className='max-w-7xl mx-auto px- py-10'>
          <h2 className='flex items-center justify-center gap-3 text-3xl font-bold mc-10 
